...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br  from-slate-50 via-gray-50 to-gray-100 relative overflow-hidden font-space-grotesk">
      ...
      <div className="absolute top-[400px] left-48 w-16 h-16 p-4 bg-white rounded-full shadow-lg animate-float animation-delay-4000">
        <img src={icon4} alt="AI Brain Icon" />
      </div>
      <div className="absolute top-[600px] left-20 w-16 h-16 p-4 bg-white rounded-full shadow-lg animate-float animation-delay-4000">
